...
let apiUrlCityList = "https://vicopo.selfbuild.fr/cherche/";
...
function updateTodayWeather(forecast) {
    const tab = ["3H00", "6H00", "9H00", "12H00", "15H00", "18H00", "21H00"];
    let i = 0;
...
function onKeyDown() {
    if (inputText.value.length > 2)
        createDatalist(inputText.value);
}
